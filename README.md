<div align="center">
  ...
  <img src="assets/hero-banner.svg" alt="Adaptiva - Technology that adapts to the way you learn" width="100%" />
  ...
  <img src="https://img.shields.io/github/stars/skandakn/Adaptiva?style=flat-square&color=yellow" alt="Stars" />
  ...
  <p align="center">
    <b>Adaptiva</b> is a next-generation AI-powered adaptive accessibility platform that dynamically transforms complex educational material in real-time according to individual cognitive, visual, auditory, and neurodivergent profiles.
  </p>
...
<div align="center">
  <img src="assets/adaptiva-hero-showcase.jpg" alt="Adaptiva 3D Product Showcase" width="100%" style="border-radius: 14px; box-shadow: 0 20px 40px rgba(0,0,0,0.6);" />
</div>
...
## 💡 The Problem & The Adaptiva Solution
...
| Traditional Learning Platforms ❌ | Adaptiva Adaptive Experience ✨ |
| :--- | :--- |
...
<div align="center">
  <img src="assets/features-grid.svg" alt="Adaptiva Core Features" width="100%" />
</div>
...
<div align="center">
  <img src="assets/demo-showcase.svg" alt="Adaptiva Split Learning View" width="100%" />
</div>

<p align="center">
  <i>The 3-panel Adaptiva Workspace: Original Dense Document ➔ Real-time AI Transformation Engine ➔ Multimodal Dyslexia/ADHD Accommodations &amp; Concept Mind Map.</i>
</p>
...
<div align="center">
  <img src="assets/architecture-diagram.svg" alt="Adaptiva Architecture Diagram" width="100%" />
</div>
...
git clone https://github.com/skandakn/Adaptiva.git
...
> [!NOTE]
> **Zero-Key Hackathon Demo Mode**: If `GROQ_API_KEY` or `SUPABASE` keys are not provided, Adaptiva gracefully falls back to built-in simulated data and local offline storage so you can test the full user journey seamlessly!
...
Open **[http://localhost:3000](http://localhost:3000)** in your browser to experience Adaptiva!
...
Adaptiva unifies all multimodal transformations inside `lib/ai-service.ts`. Available service methods include:
...
Adaptiva is engineered from the ground up to comply with **WCAG 2.1 Level AAA** guidelines:
...
`supabase/migrations/20260821173000_initial_adaptiva_schema.sql`
...
1. Fork the Project (`https://github.com/skandakn/Adaptiva/fork`)
...
<div align="center">
  ...
  **Created with 💚 by [Skanda K N](https://github.com/skandakn)**
  ...
  <a href="https://github.com/skandakn/Adaptiva/stargazers"><img src="https://img.shields.io/badge/Star%20Repo-⭐-yellow?style=for-the-badge" alt="Star Adaptiva" /></a>
  <a href="https://github.com/skandakn/Adaptiva/issues"><img src="https://img.shields.io/badge/Report%20Issue-🐛-red?style=for-the-badge" alt="Report Issue" /></a>
